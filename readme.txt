...
= 2.1.7 =
* Fix "Test connection" failing with "Insufficient scope: payments:read required" on OAuth-connected stores; the check now uses an endpoint covered by the scopes the plugin actually requests
