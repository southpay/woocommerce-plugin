...
define( 'SOUTPAYGW_VERSION', '2.1.6' );
...
define( 'SOUTPAYGW_OAUTH_CLIENT_ID', 'spo_app_woocommerce' );
define( 'SOUTPAYGW_OAUTH_SCOPES', 'payments:write webhooks:write stores:read offline_access' );
